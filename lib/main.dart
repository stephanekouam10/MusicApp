...
class _MyHomePageState extends State<MyHomePage> {
  ...
  ///Gestion des textes avec stule.final
  ...
  void configAudioPlayer () {
    ...
    positionSubcription = audioPlayer.onAudioPositionChanged.listen((pos) {
      setState(() {
        position = pos;
      });
      if (position >= duree){
    ...
    stateSubcription = audioPlayer.onPlayerStateChanged.listen((state) {
